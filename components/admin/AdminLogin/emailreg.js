      ...
      .then((res) => {
        if (res.payload.success) {
          setCookies(
            ...
            res.payload.data.userData.Role.key,
            res.payload.data.userData.id
          );
          localStorage.setItem("token", res.payload.data.token);
          ...
          let errorMessage = res.payload.message.user
            ? res.payload.message.user
            : res.payload.message.password
            ? res.payload.message.password
            : "An Error Occurred";
                  ...
                  <div className="logo_login_main">
                    <div class="text-center">
                      <Image
                        width={65}
                        height={65}
                        src="/images/infraPrimeLogo.svg"
                        alt=""
                        class="img-fluid login_logo_img"
                      />
                      <h1>InfraPrime Logistics Login</h1>
                      <p className="mb-0">
                        This is a secure site. Please enter your information to
                        enter.
                      </p>
                    </div>
                    ...
                    <div className="login_form_main">
                      <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group
                          className="remember_pass d-flex justify-content-between"
