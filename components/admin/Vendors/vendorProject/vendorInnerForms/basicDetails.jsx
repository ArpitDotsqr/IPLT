...
const VendorsBasicDetails = (props) => {
  ...
  const organizationtypeList = useSelector(
    (state) => state.masterSlice.organisationMasterDataList?.MasterData?.rows
  );
          ...
          <Col md={4}>
            <Field name="vendorTypeId">
              {({ input, meta }) => (
                <div className="">
                  <div>
                    <label className="">Vendor Type</label>
                  ...
                  <select
                    ...
                    {masterList?.length > 0 &&
                      masterList.map((item, index) => (
                        <option key={`vendorType_${index}`} value={item?.name}>
                          {item?.displayName}
                        </option>
                      ))}
                  </select>
                ...
                <div className="">
                  ...
                  <select
                    ...
                    {organizationtypeList?.length > 0 &&
                      organizationtypeList.map((item, index) => (
                        <option key={`Org_${index}`} value={item?.id}>
                          {item?.displayName}
                        </option>
                      ))}
                  </select>
                          ...
                          <div className="comman_add_btn">
                            <Button
                              ...
                              onClick={() => {
                                ...
                                setDisplayIndex(values?.contactDetails?.length);
                              }}>
                              Add Contact
                            </Button>
                          </div>
